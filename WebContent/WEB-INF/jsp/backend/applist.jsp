...
<div class="row">
	...
	<div class="col-md-12">
		<div class="x_panel">
			...
			<div class="x_content">
				<form id="myForm" method="post" action="list">
			    ...
			    <ul>
					<li>
						<div class="form-group">
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
								<input name="softwareName" id="softwareName" type="text" class="form-control col-md-7 col-xs-12" value="${querySoftwareName }">
							</div>
						</div>
					</li>
					...
					<li>
						<div class="form-group">
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
        						<select id="queryCategoryLevel2" name="categoryLevel2" class="form-control">
        						<option value="0" selected="selected">--请选择--</option>
        						</select>
							</div>
						</div>
					...
					<li>
						<div class="form-group">
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
        						<select id="queryCategoryLevel3" name="categoryLevel3" class="form-control">
									   <option value="0" selected="selected">--请选择--</option>
        						</select>
							</div>
						</div>
					</li>
					<li><button type="button" id="search" class="btn btn-primary"> 查 &nbsp;&nbsp;&nbsp;&nbsp;询 </button></li>
				</ul>
			</form>
		</div>
	</div>
								...
								<c:forEach var="appInfo" items="${appInfoList }" varStatus="status">
									<tr role="row" class="odd">
										...
										<button type="button" class="btn btn-default checkApp" 
											...
											statusname="${appInfo.statusName }" path="${pageContext.request.contextPath }"											
