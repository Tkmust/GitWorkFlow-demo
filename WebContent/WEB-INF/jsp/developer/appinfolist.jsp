				...
				<div class="row">
					...
					<a href="${pageContext.request.contextPath}/dev/flatform/app/appinfoadd" class="btn btn-success btn-sm">新增APP基础信息</a>
                      ...
                      <ul class="dropdown-menu" role="menu">
                        ...
                        <li><a class="addVersion" path="${pageContext.request.contextPath }" appinfoid="${appInfo.id }" data-toggle="tooltip" data-placement="top" title="" data-original-title="新增APP版本信息">新增版本</a>
                        </li>
                        <li><a class="modifyVersion" path="${pageContext.request.contextPath }"
                        ...
                        <li><a  class="modifyAppInfo" path="${pageContext.request.contextPath }"
                        ...
                        <li><a  class="viewApp" path="${pageContext.request.contextPath }"  appinfoid=${appInfo.id }  data-toggle="tooltip" data-placement="top" title="" data-original-title="查看APP基础信息以及全部版本信息">查看</a></li>
						<li><a  class="deleteApp" path="${pageContext.request.contextPath }" appinfoid=${appInfo.id }  appsoftwarename=${appInfo.softwareName } data-toggle="tooltip" data-placement="top" title="" data-original-title="删除APP基础信息以及全部版本信息">删除</a></li>
                      </ul>
                    </div>
										</td>
									</tr>
				...
				<div class="row">
					<div class="col-sm-5">
						<div class="dataTables_info" id="datatable-responsive_info"
							...
							${pages.nowPage }/${pages.contPage }页</div>
					</div>
					<div class="col-sm-7">
							...
							<ul class="pagination">
								<c:if test="${pages.nowPage > 1}">
									...
									<li class="paginate_button "><a
										href="javascript:page_nav(document.forms[0],${pages.nowPage-1});"
										aria-controls="datatable-responsive" data-dt-idx="1"
										tabindex="0">上一页</a>
									</li>
								</c:if>
								<c:if test="${pages.nowPage < pages.contPage }">
									<li class="paginate_button "><a
										href="javascript:page_nav(document.forms[0],${pages.nowPage+1 });"
										aria-controls="datatable-responsive" data-dt-idx="1"
										tabindex="0">下一页</a>
									...
									<li class="paginate_button next"><a
										href="javascript:page_nav(document.forms[0],${pages.contPage });"
